...
- **Browser control** — agents can interact with web
- **Async interaction** — agents work in background
- **Multi-model** — Gemini, Claude, GPT-OSS in one platform
- **CLI included** — terminal-based agent interactions
